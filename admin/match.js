...
function getMatchHtml(mid, mdate, winab){
    ...
    $.ajax({
        ...
        success : function(data, textStatus, jqXHR) {
            ...
            $("#MatchInfoDesc").text("경기일자: " + mdate + ", " + winab);
...
function setTeamByMatch(team, id, name) {
    ...
    if (team == "A") {
        ...
        str += "  <td>" + name + "</td>";
        str += "  <td>";
        str += "<input type='number' name='teamAgoal' id='teamAgoal_" + id + "' value='0' style='width:30px;'>";
        str += " <button class='btn btn-sm btn-primary' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"plusValueMatch('teamAgoal_"+id+"');\">+</button>";
        str += " <button class='btn btn-sm btn-danger' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"minusValueMatch('teamAgoal_"+id+"');\">-</button>";
        str += "  </td>";
        str += "  <td>";
        str += "<input type='number' name='teamAasst' id='teamAasst_" + id + "' value='0' style='width:30px;'>";
        str += " <button class='btn btn-sm btn-primary' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"plusValueMatch('teamAasst_"+id+"');\">+</button>";
        str += " <button class='btn btn-sm btn-danger' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"minusValueMatch('teamAasst_"+id+"');\">-</button>";
        str += "  </td>";
        str += "</tr>";
        ...
        str += "  <td>" + name + "</td>";
        str += "  <td>";
        str += "<input type='number' name='teamBgoal' id='teamBgoal_" + id + "' value='0' style='width:30px;'>";
        str += " <button class='btn btn-sm btn-primary' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"plusValueMatch('teamBgoal_"+id+"');\">+</button>";
        str += " <button class='btn btn-sm btn-danger' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"minusValueMatch('teamBgoal_"+id+"');\">-</button>";
        str += "  </td>";
        str += "  <td>";
        str += "<input type='number' name='teamBasst' id='teamBasst_" + id + "' value='0' style='width:30px;'>";
        str += " <button class='btn btn-sm btn-primary' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"plusValueMatch('teamBasst_"+id+"');\">+</button>";
        str += " <button class='btn btn-sm btn-danger' style='padding:0 0.25rem; width:24px; height:24px;' onclick=\"minusValueMatch('teamBasst_"+id+"');\">-</button>";
        str += "  </td>";
        str += "</tr>";
